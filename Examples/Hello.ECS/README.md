...
A compact `NGIN.ECS` application showing plain component types, entities,
queries, systems, and simulation stepping.

Read [`Hello.ECS.nginproj`](Hello.ECS.nginproj) and the files under
[`src/`](src), then run:
