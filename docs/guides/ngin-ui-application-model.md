...
The buildable
[`NGIN.UI.Gallery`](../../Examples/NGIN.UI.Gallery/) demonstrates every rule in
this guide. Its
[`Model`](../../Examples/NGIN.UI.Gallery/include/NGIN/UIGallery/Gallery.hpp)
owns state while
[`ComposeMainView()`](../../Examples/NGIN.UI.Gallery/src/Gallery.cpp) emits
declarations.
...
The buildable
[`NGIN.UI.Gallery.Tests`](../../Examples/NGIN.UI.Gallery.Tests/) is the
canonical end-to-end example. Focused unit examples live in
[`Packages/NGIN.UI/tests`](../../Packages/NGIN.UI/tests/).
