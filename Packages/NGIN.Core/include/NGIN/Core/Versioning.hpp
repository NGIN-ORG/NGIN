...
namespace NGIN::Core
{
    ...
    [[nodiscard]] auto ParseSemanticVersion(std::string_view text) noexcept -> CoreResult<SemanticVersion>;
    [[nodiscard]] auto ParseVersionRange(std::string_view text) noexcept -> CoreResult<VersionRange>;
