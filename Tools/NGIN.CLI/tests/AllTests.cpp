...
<Project SchemaVersion="4" Name="Profile.App" DefaultProfile="dev">
  ...
  <Profile Name="shipping">
    ...
    REQUIRE(exitCode == 0);
    REQUIRE_THAT(captured.str(), ContainsSubstring(R"("name":"shipping")"));
    REQUIRE_THAT(captured.str(), ContainsSubstring(R"("buildType":"Release")"));
}
...
<Project SchemaVersion="4" Name="Workspace.Policy.App">
  <Application />
    ...
    REQUIRE_THAT(captured.str(), ContainsSubstring(R"("name":"shipping")"));
    REQUIRE_THAT(captured.str(), ContainsSubstring(R"("buildType":"Release")"));
    REQUIRE_THAT(captured.str(), ContainsSubstring(R"("platform":"windows-x64")"));
