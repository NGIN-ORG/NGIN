...
namespace NGIN::Runtime
{
    namespace
    {
        ...
        [[nodiscard]] auto ParseModuleFamily(const std::string_view text) -> ModuleFamily
        {
            ...
            if (text == "RuntimeSvc") return ModuleFamily::RuntimeSvc;
        ...
        [[nodiscard]] auto ParseDescriptorFromJson(
            ...
            ModuleDescriptor& out) noexcept -> RuntimeResult<void>
        {
    ...
    auto StaticModuleCatalog::Register(StaticModuleRegistration registration) noexcept -> RuntimeResult<void>
    {
    ...
    auto FilesystemPluginCatalog::CollectDescriptors(std::vector<ModuleDescriptor>& out) noexcept -> RuntimeResult<void>
    {
        try
        {
