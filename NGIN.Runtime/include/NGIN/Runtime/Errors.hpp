...
/// @file Errors.hpp
/// @brief Structured error model for runtime kernel operations.
...
{
    /// @brief Runtime-kernel error code catalog.
    ...
    template<typename T>
    using RuntimeResult = NGIN::Utilities::Expected<T, KernelError>;
