...
[`NGIN.UI.Gallery.Tests`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery.Tests/) product is the
application-level reference, while
[`SoftwareRendererTests.cpp`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/tests/SoftwareRendererTests.cpp)
...
[0.2 release notes](https://github.com/NGIN-ORG/NGIN/blob/main/docs/guides/ngin-ui-v0.2-release.md).
...
[`tests/install-consumer`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/tests/install-consumer/) as an
...
[compatibility policy](https://github.com/NGIN-ORG/NGIN/blob/main/docs/policies/ngin-ui-source-compatibility.md).
