...
[`NGIN.UI.Gallery.Hosted`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery.Hosted/). It shares
[`ComposeMainView()`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery/src/Gallery.cpp) with the
standalone gallery.
...
The gallery's
[`main.cpp`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery.Hosted/src/main.cpp) shows the full
