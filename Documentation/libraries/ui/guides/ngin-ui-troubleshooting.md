...
The buildable
[`NGIN.UI.Gallery`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery/) and
[`NGIN.UI.Gallery.Tests`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery.Tests/) separate native
...
Use the focused
[`ContractTests.cpp`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/tests/ContractTests.cpp) behavior
