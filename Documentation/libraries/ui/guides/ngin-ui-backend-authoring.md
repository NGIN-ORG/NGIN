...
The buildable
[`NGIN.UI.Gallery`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery/) exercises a real backend
pair, while
[`NGIN.UI.Gallery.Tests`](https://github.com/NGIN-ORG/NGIN/tree/main/Examples/NGIN.UI.Gallery.Tests/) exercises the
same view through deterministic test backends.

Use these buildable references:

- [`NGIN.UI.Backend.SDL3`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI.Backend.SDL3/) for a native
  platform and SDL_GPU implementation;
- [`TestPlatformBackend`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/src/NGIN/UI/Testing/TestPlatformBackend.cpp)
  for a deterministic platform implementation;
- [`RecordingRenderBackend`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/src/NGIN/UI/Testing/RecordingRenderBackend.cpp)
  for a deterministic renderer implementation;
- [`ContractTests.cpp`](https://github.com/NGIN-ORG/NGIN/tree/main/Packages/NGIN.UI/tests/ContractTests.cpp) for
