---
title: NGIN.Base Serialization API
description: Strict JSON and XML documents, ownership models, limits, diagnostics, event parsing, builders, and writers.
---

# NGIN.Base Serialization API
